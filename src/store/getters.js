import ColiberateServer from './server-functions'
...
const coliberateServer = new ColiberateServer()
...
export default {
  ...
  server: state => coliberateServer,
  dateFunctions: state => DateFunctions
}
