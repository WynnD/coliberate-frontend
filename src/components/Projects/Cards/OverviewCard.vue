<template>
  <div class="ui card">
    ...
    <div id="tasks-progress" class="content">
      <p class="ui sub header">Tasks</p>
      <div class="ui green progress">
        <div class="bar finished"/>
      </div>
      <p class="ui sub header aligned right">{{tasks_finished}}/{{num_tasks}} Completed</p>
    </div>
    <div id="stories-progress" class="content">
      <p class="ui sub header">Stories</p>
      <div class="ui green progress">
        <div class="bar finished"/>
      </div>
      <p class="ui sub header aligned right">{{stories_finished}}/{{num_stories}} Completed</p>
    </div>
    <div id="features-progress" class="content">
      <p class="ui sub header">Features</p>
      <table class="ui very basic celled table">
        <tbody>
          <tr v-for="(percent, name) in features"
          :key="name">
            <td>{{name}}</td>
            <td>{{percent}}%</td>
          </tr>
...
export default {
  ...
  methods: {
    ...
    updateTasksProgress () {
      let tasks_progress = $('#tasks-progress .progress')
    ...
    updateStoriesProgress () {
      let stories_progress = $('#stories-progress .progress')
